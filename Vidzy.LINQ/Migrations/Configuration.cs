...
namespace Vidzy.LINQ.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Vidzy.LINQ.Context.VidzyContext>
    {
        ...
        protected override void Seed(Vidzy.LINQ.Context.VidzyContext context)
        {
